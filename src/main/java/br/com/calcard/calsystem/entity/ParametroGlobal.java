...
public class ParametroGlobal extends CalsystemEntity {
	...
	/**
	 * Parametro define se nas operações realizadas com {@link Voucher} o
	 * sistema deve obrigar que {@link Voucher} tenha sido gerado no mesmo
	 * {@link Estabelecimento} em que a operação está sendo realizada.
	 */
	public static final String PARAMETRO_VOUCHER_VALIDA_ESTABELECIMENTO = "VOUCHER_VALIDA_ESTABELECIMENTO";

	public static final String QTD_DIAS_ULTIMA_PROPOSTA_NEGADA = "QTD_DIAS_ULTIMA_PROPOSTA_NEGADA";

	public static final String PARAMETRO_CODIGO_USUARIO_CLEAR_SALE = "CODIGO_USUARIO_CLEAR_SALE";

	public static final String PARAMETRO_CAMINHO_DOCUMENTO_DIGITALIZADO = "CAMINHO_DOCUMENTO_DIGITALIZADO";

	public static final String PARAMETRO_FORMATO_ARQUIVO = "FORMATO_ARQUIVO";

	public static final String PARAMETRO_PROPORCAO_THUMB = "PROPORCAO_THUMB";

	public static final String PARAMETRO_NUMERO_DEFAULT_CR = "NUMERO_CR";

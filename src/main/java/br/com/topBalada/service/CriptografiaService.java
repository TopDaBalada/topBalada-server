...
public class CriptografiaService {
	...
	public static void main(String[] args) throws ServiceException {
		...
		CriptografiaService.RSA rsa;

		rsa = new CriptografiaService().new RSA();

		// rsa.doGerarArquivo(2048, "publicKeySMS", "privateKeySMS");
	...
	public class HASH {
		...
		public String MD5(String message) throws ServiceException {
			try {
	...
	public class RSA {
		...
		private static final String PATH = "C:\\key";
		private static final String EXTENSAO = ".key";
		...
		public String doCriptografar(String mensagem, String nomeArquivoChave)
				throws ServiceException {

			PublicKey key = this.doCarregarPublicKey(nomeArquivoChave);
		...
		public void doGerarArquivo(int keySizeBits,
				String nomeArquivoChavePublica, String nomeArquivoChavePrivada)
				throws ServiceException {

			this.doGerarChave(keySizeBits);
		...
		public RSA doCarregarKeyPair(String nomeArquivoPublicKey,
				String nomeArquivoPrivateKey) throws ServiceException {

			keyPair = new KeyPair(doCarregarPublicKey(nomeArquivoPublicKey),
					doCarregarPrivateKey(nomeArquivoPrivateKey));

			return this;
		}

		private PrivateKey doCarregarPrivateKey(String nomeArquivo)
				throws ServiceException {

			try {

				File filePrivateKey = new File(PATH + "/" + nomeArquivo
						+ EXTENSAO);
				FileInputStream fis;
		...
		private PublicKey doCarregarPublicKey(String nomeArquivo)
				throws ServiceException {

			try {

				File filePublicKey = new File(PATH + "/" + nomeArquivo
						+ EXTENSAO);
				FileInputStream fis;
